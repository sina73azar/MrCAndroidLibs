package com.mrc.networklogger.core.interceptor

import android.util.Log
import com.mrc.networklogger.core.model.HeaderModel
import com.mrc.networklogger.core.model.NetworkLogEntry
import com.mrc.networklogger.core.model.RequestLogModel
import com.mrc.networklogger.core.model.ResponseLogModel
...
class LoggerInterceptor(
    ...
    fun Response.hasBody(): Boolean {
        ...
        return headers().contentLength() != -1L ||
                "chunked".equals(header("Transfer-Encoding"), ignoreCase = true)
    }

    private fun Headers.contentLength(): Long =
        get("Content-Length")?.toLongOrNull() ?: -1L
}
